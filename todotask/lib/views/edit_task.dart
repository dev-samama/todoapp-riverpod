...
class _EditTaskState extends ConsumerState<EditTask> {
  ...
  void initState() {
    super.initState();
    tcont.text = widget.task.name;
    desccont.text = widget.task.desc;
    isImp = widget.task.imp;
    dateString = widget.task.dueon;
  }
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            if (dateString == '') {
                              ...
                              ref.watch(editTaskProvider(EditTaskModel(
                                  index: widget.index,
                                  task: Task.tasktoString(newTask))));
